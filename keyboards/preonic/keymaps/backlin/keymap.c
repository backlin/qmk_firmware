...
[_SVORAK] = LAYOUT_preonic_2x2u(
  ...
  _,       NUMPAD,  MAGNET,  FN_LEFT,          KC_SPC,     SYMBOLS,          _,       KC_ENT,  KC_RGUI, _
),
...
[_JETBRAINS] = LAYOUT_preonic_2x2u(
  _______, JB_SHOW, JB_TO,   JB_CONT, JB_REC,  JB_UPDT,    JB_NONE, _______, _______, _______, _______, _______,
  LOCK,    JB_OUT,  JB_IN,   JB_STEP, JB_RUN,  JB_DBUG,    JB_NEW,  _______, _______, _______, _______, _______,
  _______, _______, KC_LEFT, KC_RGHT, JB_DIFF, _______,    _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______,          _______,    _______,          _______, _______, _______, _______
),

[_NUMPAD] = LAYOUT_preonic_2x2u( // Activated together with JetBrains
...
[_MAGNET] = LAYOUT_preonic_2x2u( // Activated together with JetBrains
...
[_FN] = LAYOUT_preonic_2x2u(
  _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, CB_SCRF,    _______, KC_F7,   KC_F8,   KC_F9,   _______, _______,
  QK_BOOT, _______, KC_VOLD, KC_MUTE, CB_VOLU, CB_SCRC,    _______, KC_F4,   KC_F5,   KC_F6,   _______, _______,
