 ...
 */
    [_SVORAK] = LAYOUT(
      ...
      LSFT_T(KC_COLN), KC_DOT,     KC_Q,       KC_J,       KC_K,    KC_X,  XXXXXXX,            LT(_LNAVI, KC_DOWN), LT(_RNAVI, KC_UP),   XXXXXXX,            KC_B,  KC_M,  KC_W,  KC_V,  KC_Z,  RSFT_T(KC_SCLN),
                                LCTL_T(DM_RSTP), KC_LGUI, LALT_T(KC_COMM), LT(_LSYMB, KC_SPC), LT(_LNUMB, KC_LEFT), LT(_RNUMB, KC_RGHT), LT(_RSYMB, KC_ENT), RALT_T(KC_DOT), KC_RGUI, KC_RCTL
    ),
...
// Max line length = 18. If len = 18 then no trailing newline (10)
static void render_svorak_left(void) {
  static const char PROGMEM svorak_left[] = {
    ...
    32, 58, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 145, 146, 147,
    32, 32, 32, 32, 32, 16, 17, 18, 32, 22, 32, 19, 20, 21, 32, 161, 162, 163,
    32, 32, 32, 32, 32, 32, 26, 32, 32, 32, 32, 32, 44, 32, 32, 177, 178, 179,
    0
  };
...
static void render_svorak_right(void) {
  static const char PROGMEM svorak_right[] = {
    ...
    149, 150, 151, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 59, 10,
    165, 166, 167, 32, 19, 20, 21, 32, 22, 32, 16, 17, 18, 10,
    181, 182, 183, 32, 32, 46,
    0
  };
...
static void render_qwerty_right(void) {
  static const char PROGMEM qwerty_right[] = {
    ...
    149, 150, 151, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 59, 32,
    165, 166, 167, 32, 19, 20, 21, 32, 22, 32, 16, 17, 18, 10,
    181, 182, 183, 32, 32, 46,
    0
  };
...
static void render_symbols_left(void) {
  static const char PROGMEM symbols_left[] = {
    ...
    10,
    32, 32, 32, 32, 92, 32, 32, 47, 32, 32, 40, 32, 32, 41, 32, 32, 94, 10,
    10,
    217, 218, 219, 32, 46, 32, 32, 32, 32, 32, 60, 32, 32, 62, 32, 32, 37, 10,
    32, 58, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 152, 153, 154,
    32, 32, 32, 32, 32, 16, 17, 18, 32, 22, 32, 19, 20, 21, 32, 168, 169, 170,
    32, 32, 32, 32, 32, 32, 26, 32, 32, 32, 32, 32, 44, 32, 32, 184, 185, 186,
    0
  };
...
static void render_symbols_right(void) {
  static const char PROGMEM symbols_right[] = {
    ...
    155, 156, 157, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 59, 10,
    171, 172, 173, 32, 19, 20, 21, 32, 22, 32, 16, 17, 18, 10,
    187, 188, 189, 32, 32, 46, 32,
    0
  };
...
static void render_numeric_left(void) {
  static const char PROGMEM numeric_left[] = {
    202, 203, 204, 65, 66, 67, 65, 68, 69, 65, 70, 71, 65, 72, 73, 32, 43, 10,
    10,
    205, 206, 204, 65, 74, 75, 65, 76, 77, 65, 78, 79, 65, 80, 81, 32, 45, 10,
    10,
    217, 218, 219, 65, 82, 83, 84, 85, 86, 84, 87, 88, 84, 89, 90, 32, 42, 10,
    32, 58, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 145, 158, 159,
    32, 32, 32, 32, 32, 16, 17, 18, 32, 22, 32, 19, 20, 21, 32, 207, 174, 175,
    32, 32, 32, 32, 32, 32, 26, 32, 32, 32, 32, 32, 44, 32, 32, 177, 190, 191,
    0
  };
...
static void render_numeric_right(void) {
  static const char PROGMEM numeric_right[] = {
    32, 31, 32, 32, 49, 32, 32, 50, 32, 32, 51, 32, 32, 52, 32, 202, 208, 209,
    10,
    32, 61, 32, 32, 53, 32, 32, 54, 32, 32, 55, 32, 32, 56, 32, 205, 210, 209,
    10,
    32, 46, 32, 32, 57, 32, 32, 48, 32, 32, 32, 32, 32, 32, 32, 217, 218, 219,
    160, 192, 151, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 59, 10,
    176, 193, 194, 32, 19, 20, 21, 32, 22, 32, 16, 17, 18, 10,
    177, 178, 183, 32, 32, 46,
    0
  };
...
static void render_navigation_left(void) {
  static const char PROGMEM navigation_left[] = {
    23, 24, 25, 32, 43, 104, 32, 43, 115, 32, 43, 116, 32, 43, 109, 32, 10,
    10,
    32, 32, 32, 32, 45, 32, 32, 45, 32, 32, 45, 32, 32, 45, 32, 32, 10,
    10,
    217, 218, 219, 211, 212, 213, 214, 215, 216, 220, 221, 222, 223, 224, 225, 226, 227, 228,
    32, 58, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 145, 146, 164,
    32, 32, 32, 32, 32, 16, 17, 18, 32, 22, 32, 19, 20, 21, 32, 195, 196, 180,
    32, 32, 32, 32, 32, 32, 26, 32, 32, 32, 32, 32, 44, 32, 32, 177, 178, 183,
    0
  };
...
static void render_navigation_right(void) {
  static const char PROGMEM navigation_right[] = {
    32, 127, 128, 129, 130, 129, 129, 131, 129, 129, 133, 129, 129, 135, 129, 136, 137,
    32, 138, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 139, 140,
    32, 32, 32, 32, 141, 32, 32, 142, 32, 32, 143, 32, 32, 144, 10,
    10,
    32, 32, 32, 32, 27, 32, 32, 30, 32, 32, 29, 32, 32, 28, 32, 217, 218, 219,
    197, 198, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 59, 10,
    199, 200, 201, 32, 19, 20, 21, 32, 22, 32, 16, 17, 18, 10,
    177, 229, 32, 32, 32, 46,
    0
  };
