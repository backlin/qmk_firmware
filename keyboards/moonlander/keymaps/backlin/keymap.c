...
KEYMAP keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_SVORAK] = LAYOUT_moonlander(
        ...
        KC_LCTL, NUMPAD,  FN_LEFT, KC_LALT, KC_LGUI,          TX_SESS,    KC_MUTE,          SYMBOLS, SYM_ALT, FN_RGHT, TT(_NUMPAD),KC_RGUI,
    ...
    [_NUMPAD] = LAYOUT_moonlander(
        ...
        TG(_NUMPAD),JB_OUT,JB_IN,   JB_STEP, JB_RUN,  JB_DBUG, JB_NEW,     _______, _______, KC_P4,   KC_P5,   KC_P6,   KC_PSLS, KC_PMNS,
        _______,  KC_LEFT, KC_RGHT, JB_DIFF, _______, _______,                      _______, KC_P1,   KC_P2,   KC_P3,   _______, _______,
    ...
    [_FN] = LAYOUT_moonlander(
        ...
        EE_CLR,  JB_BREK, JB_SHOW, JB_TO,   JB_CONT, CB_SCRF, _______,    KC_MPRV, KC_MPLY, KC_MNXT, MAG_1_3, MAG_2_3, MAG_3_3, G(KC_PPLS),
